document.addEventListener('DOMContentLoaded', function() {
    ...
    const questions = [
        {
            text: "مرحبا بك في قسم MEDIA لإرسال فكرتك رجاءا الجواب على الأسئلة التي تطرح عليك وشكرا",
            isWelcome: true
        },
        {
            text: "أكتب كلمة المرور بأنك عضو في MEDIA",
            field: 'password',
            validate: (value) => value.trim().toLowerCase() === 'kawtherd'
        },
        {
    ...
    function showCompletionMessage() {
        ...
        .then(data => {
            ...
            successDiv.innerHTML = `
                تم تحويل هذا الموضوع إلى مسؤول قسم Media<br>
